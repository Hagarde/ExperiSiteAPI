export const population = 1000000; // 1 000 0000 
export const I0 = 50; 

export const alpha = 1; // C'est l'accumulation de connaisance et structurelle qui augmente l'efficacité ==> alpha = 2 ==> 100 tests ont l'effet de 10 000 
